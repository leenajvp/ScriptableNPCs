...
{
    public BoidBasic basicBehaviour;
    public BoidAgressive agressiveBehaviour;
    ...
    void Observe()
    {
        ...
        foreach (var col in colliders)
        {
            ...
            if (playerDetected != null)
            {
                ...
                boidSpeed = agressiveBehaviour.speed;
                boidDetection = agressiveBehaviour.detectionRange;
